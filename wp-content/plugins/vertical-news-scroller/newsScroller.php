                                    ...
                                    <?php
                                        ...
                                        if($rowsCount > 0){
                                            ...
                                            <tr valign="top" >
                                                ...
                                                <td class=""   data-title="<?php echo __('Name','vertical-news-scroller'); ?>" ><strong><?php echo $row['title'] ?></strong></td>  
    ...
    ?><!-- print_verticalScroll_func -->
      <?php if($news_style=='classic'){ ?>  
       ...
       <?php if($news_style=='classic'){ ?>  
        ...
        function rvns(fvns){/in/.test(document.readyState)?setTimeout(rvns,9,fvns):fvns()}
                  rvns(function(){
                    var $n = jQuery.noConflict();  
                    $n(function(){
