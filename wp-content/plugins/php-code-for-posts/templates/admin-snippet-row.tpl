<tr class="snippet-id-<?php echo $snippet->get_id()?>">
	...
	<td valign="middle"><code><?php echo $snippet->get_display_shortcode() ?></code> <?php if ($snippet->get_slug() != '') { ?><br /> <code><?php echo $snippet->get_display_shortcode(true) ?></code><?php } ?></td>
